...
class AlexNet(nn.Module):
    ...
    #     self.conv1.register_forward_hook(self.save_output)
    #     self.conv2.register_forward_hook(self.save_output)
    #     self.conv3.register_forward_hook(self.save_output)
    #     self.conv4.register_forward_hook(self.save_output)
    #     self.conv5.register_forward_hook(self.save_output)
    #     self.avgpool.register_forward_hook(self.save_output)
    #     self.fc6.register_forward_hook(self.save_output)
    #     self.fc7.register_forward_hook(self.save_output)
    #     self.fc8.register_forward_hook(self.save_output)
